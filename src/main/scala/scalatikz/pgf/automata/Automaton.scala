...
case class Automaton private (
  ...
  /**
    ...
    */
  def havingStateDistance(centimeters: Int): Automaton =
    copy(nodeDistance = centimeters)
  ...
  /**
    ...
    */
  def initialState(id: Int, name: String): Automaton =
  ...
  def initialState(
      ...
      lineSize: LineSize = LineSize.THICK)(id: Int, name: String): Automaton =
    copy(states =
      State(
        id,
        name,
  ...
  /**
    ...
    */
  def acceptingState(id: Int, name: String): StateConf =
    acceptingState()(id, name, None)
  ...
  /**
    ...
    * @return an Automaton having the specified accepting state
    */
  def acceptingState(id: Int, name: String, output: String): StateConf =
    acceptingState()(id, name, Some(output))
  ...
  def acceptingState(
      ...
      textColor: Color = Color.BLACK,
      lineStyle: LineStyle = LineStyle.SOLID,
      lineSize: LineSize = LineSize.THICK)(id: Int, name: String, output: Option[String] = None): StateConf =
    StateConf(copy(states =
      State(
        id,
        name,
        StateType.ACCEPTING,
  ...
  /**
    ...
    */
  def state(id: Int, name: String): StateConf =
    state()(id, name, None)
  ...
  /**
    ...
    * @return an Automaton having the specified state
    */
  def state(id: Int, name: String, output: String): StateConf =
    state()(id, name, Some(output))
  ...
  /**
    ...
    */
  def edge(from: Int, to: Int, condition: String): EdgeConf =
  ...
  def edge(
      ...
      lineSize: LineSize = THIN)(from: Int, to: Int, condition: String): EdgeConf =
    EdgeConf(copy(edges =
      Edge(
        from, to,
        condition,
