...
case class EdgeConf private[automata] (a: Automaton) {
  ...
  def bendLeft: Automaton = a.copy(edges = a.edges.head.copy(edgeType = BEND_LEFT) :: a.edges.tail)

  /** @return a right bended edge */
  def bendRight: Automaton = a.copy(edges = a.edges.head.copy(edgeType = BEND_RIGHT) :: a.edges.tail)

  /** @return a loop edge above the state */
  def loopAbove: Automaton = a.copy(edges = a.edges.head.copy(to = 0, edgeType = LOOP_ABOVE) :: a.edges.tail)

  /** @return a loop edge below the state */
  def loopBelow: Automaton = a.copy(edges = a.edges.head.copy(to = 0, edgeType = LOOP_BELOW) :: a.edges.tail)

  /** @return a loop edge left of the state */
  def loopLeft: Automaton = a.copy(edges = a.edges.head.copy(to = 0, edgeType = LOOP_LEFT) :: a.edges.tail)

  /** @return a loop edge right of the state */
  def loopRight: Automaton = a.copy(edges = a.edges.head.copy(to = 0, edgeType = LOOP_RIGHT) :: a.edges.tail)
}
