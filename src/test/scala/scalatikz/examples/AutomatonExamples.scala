...
object AutomatonExamples extends App {
  ...
  Automaton("light_blue_automaton")
    ...
    .state(drawColor = BLUE ! 50, fillColor = BLUE ! 20)(id = 1, name = "$q_1$")
    .aboveRightOf(0)
    .state(drawColor = BLUE ! 50, fillColor = BLUE ! 20)(id = 2, name = "$q_2$")
    .belowRightOf(0)
    .edge(0, 1, "0")
    .straight
    .edge(1, 1, "0")
  ...
  Automaton("colorful_automaton")
    ...
    .state(drawColor = ORANGE, fillColor = ORANGE, textColor = WHITE)(1, "$q_1$")
    .aboveRightOf(0)
    .state(drawColor = ORANGE, fillColor = ORANGE, textColor = WHITE)(2, "$q_2$")
    .belowRightOf(0)
    .acceptingState(GREEN ! 50 ! BLACK, GREEN ! 50 ! BLACK, WHITE)(3, "$q_3$")
    .belowRightOf(1)
    .edge(0, 1, "0")
    .straight
    .edge(1, 1, "0")
